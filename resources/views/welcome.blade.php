                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-gila">
                                ...
                                <p>
                                    <a href="{{ route('checkout.create', 'bagus-belajar') }}" class="btn btn-master btn-primary w-100 mt-3">
                                        Take This Plan
                                    </a>
                                </p>
                            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-biasa">
                                ...
                                <p>
                                    <a href="{{ route('checkout.create', 'awal-belajar') }}" class="btn btn-master btn-secondary w-100 mt-3">
                ...
                <div class="col-lg-10 col-12">
                    ...
                    <div class="row copyright">
                        <div class="col-lg-12 col-12">
                            <p>
                                All Rights Reserved. Copyright Stpds Bootcamp Arya.
                            </p>
                        </div>
                    </div>
                </div>
